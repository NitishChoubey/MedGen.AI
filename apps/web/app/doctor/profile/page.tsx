...
export default async function ProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* Profile Card */}
      <div className="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-6 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-slate-950 dark:bg-gray-700/50 rounded-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700">
