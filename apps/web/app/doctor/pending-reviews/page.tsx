      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0 flex items-center space-x-3">
          <div className="relative">
            ...
            <input type="text" placeholder="Search documents..." className="pl-10 pr-4 py-2 bg-white dark:bg-slate-900 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white placeholder-gray-400" />
          </div>
      ...
      {pendingReviews.length > 0 ? (
        <div className="grid gap-4">
          {pendingReviews.map((review) => (
            <Link key={review.id} href={`/doctor/review/${review.id}`} className="block bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all group">
              <div className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-300 mt-2 line-clamp-2">{review.summary?.substring(0, 150)}...</p>
